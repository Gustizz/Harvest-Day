...
public class MiniBulletTurret : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            collision.gameObject.GetComponent<AIWalkTowardsMiddle>().Damaged(damage, false);
        }
        else if (collision.gameObject.tag == "Pumkin")
        {
            collision.gameObject.GetComponent<PumkinScript>().Damaged(damage, false);
        }
        else if (collision.gameObject.tag == "Tomatoe")
        {
            collision.gameObject.GetComponent<TomatoScript>().Damaged(damage, false);
        }
